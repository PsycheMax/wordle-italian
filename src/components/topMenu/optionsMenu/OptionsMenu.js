                            ...
                            <div className="row dark:text-white text-neutral-800 mt-8 px-3 mr-2">
                                <div className=" text-base  self-start">
                                    <div className='px-5 border-b-4 mt-[-2rem] mb-2'>
                                        ...
                                        <div className='py-1'>L'idea di <a href='https://twitter.com/intent/tweet?screen_name=powerlanguish' className='font-bold'>@PowerLanguish</a> è tanto semplice quanto divertente, quindi ho deciso di omaggiarla con una traduzione italiana del suo gioco - l'ho creata da zero, non ho copiato una singola riga di codice per realizzarla. </div>
