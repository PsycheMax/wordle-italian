...
class Header extends Component {
    ...
    render(){
        return(
            <header className="menu-wrapper w-screen bg-red-600 min-h-[150px]">
                  <nav class="bg-red border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
                        <div class="container flex flex-wrap justify-between items-center mx-auto">
                        <a href="#" class="flex">
                            <Logo />
                            <SkipToContent />
                            <span class="self-center text-lg font-semibold whitespace-nowrap dark:text-white">Max Pace</span>
                        </a>
