...
class Header extends Component {
    ...
    render(){
        return(
            <header className="menu-wrapper w-screen min-h-[150px]">
                  <nav class="border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800 absolute z-10">
                        <div class="container flex flex-wrap justify-between items-center mx-auto">
                            <a href="#" class="flex">
                                <Logo />
                                <SkipToContent />
                                <span class="self-center text-lg font-semibold whitespace-nowrap dark:text-white text-white tracking-tighter">Max Pace</span>
                            </a>
                            <div class="flex items-center md:order-2">
                                <button type="button" class="flex mr-3 text-lg bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" type="button" data-dropdown-toggle="dropdown">
                        ...
                        <div className=" background-curve-sky"></div>
                <Hero />
            </header>
        )
    }
