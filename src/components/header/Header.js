                  ...
                  <nav className="border-gray-200 px-2 sm:px-4 py-2.5 rounded absolute z-10">
                        <div className="container grid grid-cols-12 items-center mx-auto">
                            <a href="#" className="flex col-span-6 lg:col-span-2 ">
                                <Logo />
                                <SkipToContent />
                                <span className="hidden md:inline-block self-center text-lg font-semibold whitespace-nowrap dark:text-white text-white tracking-tighter">Max Pace</span>
                            </a>
                            <div className="hidden md:block col-span-3"></div>
                            <div className="lg:col-span-2 flex items-center md:order-2 col-span-3">
                                {/* <button type="button" className="flex mr-3 text-lg bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" type="button" data-dropdown-toggle="dropdown">
                            ...
                            <div className="hidden md:col-span-6 justify-between items-center w-full md:flex md:w-auto md:order-1 ml-3" id="mobile-menu-2">
